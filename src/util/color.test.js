...
describe( 'As a developer, I need to be able to work with colors.', function() {
    ...
    it ( 'should be able to perform basic math on RGB values', ( ) => {
        ...
        expect(color2.a).toBe(0.5);
        color1 = new Color(10, 20, 30, 0.5);
        color2 = new Color(15, 25, 35, 0.5);
        let color3 = Color.addColor(color1, color2);
        expect(color1.r).toBe(10);
        expect(color1.g).toBe(20);
        expect(color1.b).toBe(30);
        expect(color1.a).toBe(0.5);
        expect(color2.r).toBe(15);
        expect(color2.g).toBe(25);
        expect(color2.b).toBe(35);
        expect(color2.a).toBe(0.5);
        expect(color3.r).toBe(25);
        expect(color3.g).toBe(45);
        expect(color3.b).toBe(65);
        expect(color3.a).toBe(0.5);
        color3 = Color.subtractColor(color1, color2);
        expect(color1.r).toBe(10);
        expect(color1.g).toBe(20);
        expect(color1.b).toBe(30);
        expect(color1.a).toBe(0.5);
        ...
        expect(color2.b).toBe(35);
        expect(color2.a).toBe(0.5);
        expect(color3.r).toBe(-5);
        expect(color3.g).toBe(-5);
        expect(color3.b).toBe(-5);
        expect(color3.a).toBe(0.5);
    });
    it ( 'should be able to get darker and lighter colors', ( ) => {
        let color1 = new Color(10, 20, 30, 0.5);
        let hsl1 = Color.xlateRGB255ToHSL360(color1.r, color1.g, color1.b);
        let color2 = Color.getDarkerColor(color1);
        let hsl2 = Color.xlateRGB255ToHSL360(color2.r, color2.g, color2.b);
        expect(hsl2[2]).toBe(hsl1[2] / 2);
        color2 = Color.getDarkerColor(color1, 3);
        hsl2 = Color.xlateRGB255ToHSL360(color2.r, color2.g, color2.b);
        expect(Color.isKindaSortaEqual(hsl2[2], hsl1[2] / 3, 0.15)).toBe(true);
        color1 = new Color(10, 20, 30, 0.5);
        hsl1 = Color.xlateRGB255ToHSL360(color1.r, color1.g, color1.b);
        color2 = Color.getLighterColor(color1);
        hsl2 = Color.xlateRGB255ToHSL360(color2.r, color2.g, color2.b);
        expect(hsl2[2]).toBe(Math.min(100, hsl1[2] + (hsl1[2] * 0.5)));
        color2 = Color.getLighterColor(color1, 0.33);
        hsl2 = Color.xlateRGB255ToHSL360(color2.r, color2.g, color2.b);
        expect(Color.isKindaSortaEqual(hsl2[2],  hsl1[2] + (hsl1[2] * 0.33), 0.15)).toBe(true);
    });
    it ( 'should be able to rotate the hue of a color', ( ) => {
        let color1 = new Color(10, 20, 30, 0.5);
        let hsl = Color.xlateRGB255ToHSL360(color1.r, color1.g, color1.b);
        expect(hsl[0]).toBe(210);
        let rotatedHue = Color.rotateHue(hsl[0], 20);
        expect(rotatedHue).toBe(230);
        rotatedHue = Color.rotateHue(hsl[0], 200);
        expect(rotatedHue).toBe(50);
        rotatedHue = Color.rotateHue(hsl[0], -200);
        expect(rotatedHue).toBe(10);
        rotatedHue = Color.rotateHue(hsl[0], -220);
        expect(rotatedHue).toBe(350);
    });
    it ( 'should be able to create a complimentary color scheme for a given color', ( ) => {
        let color1 = new Color(10, 20, 30, 0.5);
        let hsl = Color.xlateRGB255ToHSL360(color1.r, color1.g, color1.b);
        let rotatedHue = Color.rotateHue(hsl[0], 180);
        let rgb = Color.xlateHSL360ToRGB255(rotatedHue, hsl[1], hsl[2]);
        let complimentaryColor = new Color(rgb[0], rgb[1], rgb[2], color1.a, false, false);
        let scheme = Color.getComplimentaryColorScheme(color1);
        expect(Array.isArray(scheme)).toBe(true);
        expect(scheme.length).toBe(2);
        expect(color1.isEqual(scheme[0])).toBe(true);
        expect(complimentaryColor.isEqual(scheme[1])).toBe(true);
    });
    it ( 'should be able to create a split complimentary color scheme for a given color', ( ) => {
        let color1 = new Color(10, 20, 30, 0.5);
        let hsl = Color.xlateRGB255ToHSL360(color1.r, color1.g, color1.b);
        let rotatedHue = Color.rotateHue(hsl[0], 150);
        let rgb = Color.xlateHSL360ToRGB255(rotatedHue, hsl[1], hsl[2]);
        let color2 = new Color(rgb[0], rgb[1], rgb[2], color1.a, false, false);
        rotatedHue = Color.rotateHue(hsl[0], 210);
        rgb = Color.xlateHSL360ToRGB255(rotatedHue, hsl[1], hsl[2]);
        let color3 = new Color(rgb[0], rgb[1], rgb[2], color1.a, false, false);
        let scheme = Color.getSplitComplimentaryColorScheme(color1);
        expect(Array.isArray(scheme)).toBe(true);
        expect(scheme.length).toBe(3);
        expect(color1.isEqual(scheme[0])).toBe(true);
        expect(color2.isEqual(scheme[1])).toBe(true);
        expect(color3.isEqual(scheme[2])).toBe(true);
    });
    it ( 'should be able to create a triad color scheme for a given color', ( ) => {
        let color1 = new Color(10, 20, 30, 0.5);
        let hsl = Color.xlateRGB255ToHSL360(color1.r, color1.g, color1.b);
        ...
        rgb = Color.xlateHSL360ToRGB255(rotatedHue, hsl[1], hsl[2]);
        let color3 = new Color(rgb[0], rgb[1], rgb[2], color1.a, false, false);
        let scheme = Color.getTriadColorScheme(color1);
        expect(Array.isArray(scheme)).toBe(true);
        expect(scheme.length).toBe(3);
        expect(color1.isEqual(scheme[0])).toBe(true);
        expect(color2.isEqual(scheme[1])).toBe(true);
    ...
    it ( 'should be able to create an analogous color scheme for a given color', ( ) => {
        let color1 = new Color(10, 20, 30, 0.5);
        let hsl = Color.xlateRGB255ToHSL360(color1.r, color1.g, color1.b);
        ...
        rgb = Color.xlateHSL360ToRGB255(rotatedHue, hsl[1], hsl[2]);
        let color3 = new Color(rgb[0], rgb[1], rgb[2], color1.a, false, false);
        let scheme = Color.getAnalogousColorScheme(color1);
        expect(Array.isArray(scheme)).toBe(true);
        expect(scheme.length).toBe(3);
        expect(color1.isEqual(scheme[0])).toBe(true);
        expect(color2.isEqual(scheme[1])).toBe(true);
    ...
    it ( 'should be able to create an rectangle (tetradic) color scheme for a given color', ( ) => {
        let color1 = new Color(10, 20, 30, 0.5);
        let hsl = Color.xlateRGB255ToHSL360(color1.r, color1.g, color1.b);
        let rotatedHue = Color.rotateHue(hsl[0], 180);
        let rgb = Color.xlateHSL360ToRGB255(rotatedHue, hsl[1], hsl[2]);
        let color2 = new Color(rgb[0], rgb[1], rgb[2], color1.a, false, false);
        rotatedHue = Color.rotateHue(hsl[0], 120);
        rgb = Color.xlateHSL360ToRGB255(rotatedHue, hsl[1], hsl[2]);
        let color3 = new Color(rgb[0], rgb[1], rgb[2], color1.a, false, false);
        rotatedHue = Color.rotateHue(hsl[0], -60);
        rgb = Color.xlateHSL360ToRGB255(rotatedHue, hsl[1], hsl[2]);
        let color4 = new Color(rgb[0], rgb[1], rgb[2], color1.a, false, false);
        let scheme = Color.getRectangleColorScheme(color1);
        expect(Array.isArray(scheme)).toBe(true);
        expect(scheme.length).toBe(4);
        expect(color1.isEqual(scheme[0])).toBe(true);
        expect(color2.isEqual(scheme[1])).toBe(true);
        expect(color3.isEqual(scheme[2])).toBe(true);
        expect(color4.isEqual(scheme[3])).toBe(true);
    });
    it ( 'should be able to create an square color scheme for a given color', ( ) => {
        let color1 = new Color(10, 20, 30, 0.5);
        let hsl = Color.xlateRGB255ToHSL360(color1.r, color1.g, color1.b);
        let rotatedHue = Color.rotateHue(hsl[0], 180);
        let rgb = Color.xlateHSL360ToRGB255(rotatedHue, hsl[1], hsl[2]);
        ...
        rgb = Color.xlateHSL360ToRGB255(rotatedHue, hsl[1], hsl[2]);
        let color4 = new Color(rgb[0], rgb[1], rgb[2], color1.a, false, false);
        let scheme = Color.getSquareColorScheme(color1);
        expect(Array.isArray(scheme)).toBe(true);
        expect(scheme.length).toBe(4);
        expect(color1.isEqual(scheme[0])).toBe(true);
        expect(color2.isEqual(scheme[1])).toBe(true);
