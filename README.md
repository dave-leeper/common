...
- [Changing the CacheController `<title>`](#changing-the-page-title)
...
- [Injecting Data from the Server into the CacheController](#injecting-data-from-the-server-into-the-page)
...
## Changing the CacheController `<title>`
...
## Injecting Data from the Server into the CacheController
...
```
{
  "hosting": {
    ...
    "headers": [
      {"source": "/service-worker.js", "headers": [{"key": "CacheController-Control", "value": "no-cache"}]}
    ]
    ...
```
